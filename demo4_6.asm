...
L1:
	...
	LSR		; Divide by 2. (now 30-0)
	LSR		; Divide by 2. (now 15-0)
	STA AUDV0	; Volume based on counter (15-0)
	LSR		; Divide by 2. (now 7-0)
	EOR #7		; Invert direction.
			; Carry result of LSR to add variation.
	ADC #12		; Frequency based on counter (8-15)
	STA AUDF0
	LDA #8		; White noise.
	STA AUDC0
	JMP L3
